-- ExplodeWeakAircraft_v8.lua 10/16/2025
...
--v8 Oct. 16, 2025.
--  - Added aship category back in after testing and realizing that the enumerations on Hoggit were wrong (swapped with ground units).  Fixed
...
local unitTypesToExplode = {
    ...
    --{unitTypeName = "Essex",                 healthTrigger = 0.5, explosionPower = 500, launchFlares = true, explosionsContinueUntilDestroyed = true},  --Essex Class Carrier 1944
    ...
    --{unitTypeName = "CVN_72",                healthTrigger = 0.5, explosionPower = 500, launchFlares = true, explosionsContinueUntilDestroyed = true}, --CVN-72 Abraham Lincoln
    ...
    --{unitTypeName = "speedboat",             healthTrigger = 0.5, explosionPower = 500, launchFlares = true, explosionsContinueUntilDestroyed = true}, 
    ...
    --{unitTypeName = "LST_Mk2",               healthTrigger = 0.5, explosionPower = 500, launchFlares = true, explosionsContinueUntilDestroyed = true}, --LST Mk.II
    ...
    --{unitTypeName = "LHA_Tarawa",            healthTrigger = 0.5, explosionPower = 500, launchFlares = true, explosionsContinueUntilDestroyed = true}, --LHA-1 Tarawa
    ...
    --{unitTypeName = "USS_Samuel_Chase",      healthTrigger = 0.5, explosionPower = 500, launchFlares = true, explosionsContinueUntilDestroyed = true}, --LS Samuel Chase
