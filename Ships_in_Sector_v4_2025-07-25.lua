-- Ships_in_Sector_v3_2025-07-11.lua
-- by GTFreeFlyer
...
local function getSector(_bearing)
    if _bearing >= 0 and _bearing < 30 then
        return "Lima"
    elseif _bearing >= 30 and _bearing < 60 then
        return "Echo"
    elseif _bearing >= 60 and _bearing < 90 then
        return "Alpha"
    elseif _bearing >= 90 and _bearing < 120 then
        return "Tango"
    elseif _bearing >= 120 and _bearing < 150 then
        return "Hotel"
    elseif _bearing >= 150 and _bearing < 180 then
        return "Oscar"
    elseif _bearing >= 180 and _bearing < 210 then
        return "Romeo"
    elseif _bearing >= 210 and _bearing < 240 then
        return "November"
    elseif _bearing >= 240 and _bearing < 270 then
        return "Uniform"
    elseif _bearing >= 270 and _bearing < 300 then
        return "Charlie"
    elseif _bearing >= 300 and _bearing < 330 then
        return "Kilo"
    elseif _bearing >= 330 and _bearing <= 360 then
        return "Sierra"
    else
        return "**script error**"
    end
